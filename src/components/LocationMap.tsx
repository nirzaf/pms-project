      ...
      <div className="container mx-auto px-4">
        ...
        >
          <p className="text-lg text-gray-700 mb-4">
            Located in the beautiful Ethukala area of Negombo, Sri Lanka, our resort offers easy access to pristine beaches and local attractions.
          </p>
          <div className="flex justify-center gap-6 mt-6">
            <div className="flex items-center">
              ...
              <span>Ethukala, Negombo, Sri Lanka</span>
            </div>
            <div className="flex items-center">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-[#050063] mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
